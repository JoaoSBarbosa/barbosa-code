                    ...
                    <div>
                        <Tabs aria-label="Full width tabs" style="fullWidth">
                            ...
                            >
                                ...
                                <p className="mb-4">
                                    <strong>Desenvolvimento Frontend:</strong> React, JavaScript, Tailwind CSS, HTML,
                                    CSS
                                </p>
                                <p className="mb-4">
                            ...
                            >
                                ...
                                <p className="mb-4">
                                    <strong>Graduação:</strong> Análise e Desenvolvimento de Sistemas (UNINTER)
                                </p>
                                <p className="mb-4">
                                    <strong>Técnico:</strong> Desenvolvimento de Sistemas (ETEC)
                                </p>

                                <Card className="max-w-sm" imgSrc="https://uploaddeimagens.com.br/images/004/723/235/full/sistema-html-para-design-de-colagem-de-sites.jpg?1706233101" horizontal>
